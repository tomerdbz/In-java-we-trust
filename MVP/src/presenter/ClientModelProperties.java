...
public class ClientModelProperties implements Serializable {
	 ...
	 */
	public ClientModelProperties(UI ui, MazeSolver mazeSolver,MazeGenerator mazeGenerator, Movement movement,double mCost,double mdCost)
	{
		this.ui=ui;
	...
	public String toString() {
		...
		str.append("Server IP: "+serverIP + "\n");
		str.append("Server Port: "+serverPort + "\n");
		return str.toString();
	}
